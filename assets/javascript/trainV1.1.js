$(function() {
    ...
    trainData.ref().on("child_added", function(childSnapshot, prevChildKey) {
        ...
        console.log("first trn:" + firstTrain);


        var trainStart = moment(firstTrain).format("MM/DD/YY");
        ...
        $("#trainTable > tbody").append("text", "<tr><td>" + name + "</td><td>" + destination + "</td><td>" + frequency + "</td><td>" + arrival + "</td><td>" + minutes + "</td><td>" + trainStart + "</td></tr>");
