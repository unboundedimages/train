$(function() {
    ...
    trainData.ref().on("child_added", function(childSnapshot, prevChildKey) {
        ...
        var trainStart = moment.unix(firstTrain).format("MM/DD/YY");
        ...
        $("#trainTable > tbody").append("<tr><td>" + name + "</td><td>" + destination + "</td><td>" + frequency + "</td><td>" + arrival + "</td><td>" + minutes + "</td><td>" + trainStart + "</td></tr>");
